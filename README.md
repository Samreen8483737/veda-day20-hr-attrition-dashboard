# Day 20: HR Attrition Dashboard (Final Project)
...
* **Data Governance:** Ensured strict HR compliance by visualizing aggregated business unit metrics rather than individual Personally Identifiable Information (PII).

## Top 5 Management Insights
1. **Critical Flight Risk (Tenure):** The column chart indicates the highest attrition rates consistently occur within the earliest years of employment, pointing to a severe issue with onboarding or initial job expectations.
...
5. **Business Recommendation:** HR should heavily investigate the first 90 days of the Sales Representative onboarding pipeline, potentially implementing mentorship programs or restructuring base compensation to plug the highest leak in the talent funnel.
